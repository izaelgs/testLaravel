  ...
  <body>
    ...
    <div class="container text-center">
        <section class="institucional">
            <div>
                <h3>O Laboratório</h3>
                <p>esse laboratorio é muito pica</p>
            </div>
            <div>
                <h3>Projetos concluídos</h3>
                <p>concluimos um monte de projeto</p>
            </div>
            <div>
                <h3>Contatos</h3>
...
Quer ajudar em nossos projetos? (Pessoa física e jurídica, formulário de cadastro único, mas tratando as duas situações)
	Formulário de Inscrição de apoio em projetos
Nossos projetos
	Projetos Concluídos
		Projeto I
		Projeto II
